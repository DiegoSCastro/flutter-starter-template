    ...
    return AppScaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ).animateSlideRight(delay: 100.ms),
          const _ThemeModeSelector().animateSlideRight(delay: 150.ms),
          const SizedBox(height: AppSpacing.sm),
          const _ColorSchemeSelector().animateSlideRight(delay: 200.ms),
          const SizedBox(height: AppSpacing.xxxl),
          const _SignOutButton().animateSlideUp(delay: 300.ms),
        ],
      ),
    );
  }
