...
mixin _$BookmarksListState {
 ...
 bool get isLoading; List<Bookmark> get items; String get query; Failure? get failure;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,const DeepCollectionEquality().hash(items),query,failure);

@override
String toString() {
  return 'BookmarksListState(isLoading: $isLoading, items: $items, query: $query, failure: $failure)';
}
...
@useResult
$Res call({
 bool isLoading, List<Bookmark> items, String query, Failure? failure
});
...
/// Create a copy of BookmarksListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? items = null,Object? query = null,Object? failure = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  List<Bookmark> items,  String query,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookmarksListState() when $default != null:
return $default(_that.isLoading,_that.items,_that.query,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  List<Bookmark> items,  String query,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _BookmarksListState():
return $default(_that.isLoading,_that.items,_that.query,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  List<Bookmark> items,  String query,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _BookmarksListState() when $default != null:
return $default(_that.isLoading,_that.items,_that.query,_that.failure);case _:
  return null;
...
class _BookmarksListState extends BookmarksListState {
  const _BookmarksListState({this.isLoading = false, final  List<Bookmark> items = const [], this.query = '', this.failure}): _items = items,super._();
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,const DeepCollectionEquality().hash(_items),query,failure);
...
/// Create a copy of BookmarksListState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? items = null,Object? query = null,Object? failure = freezed,}) {
