...
mixin _$BookmarkFormState {
 ...
 String? get id; BookmarkFormStatus get status; String get title; String get url; String get description; List<String> get tags; List<String> get imageUrls; String? get videoUrl; Failure? get failure;
...
@override
int get hashCode => Object.hash(runtimeType,id,status,title,url,description,const DeepCollectionEquality().hash(tags),const DeepCollectionEquality().hash(imageUrls),videoUrl,failure);

@override
String toString() {
  return 'BookmarkFormState(id: $id, status: $status, title: $title, url: $url, description: $description, tags: $tags, imageUrls: $imageUrls, videoUrl: $videoUrl, failure: $failure)';
}
...
@useResult
$Res call({
 String? id, BookmarkFormStatus status, String title, String url, String description, List<String> tags, List<String> imageUrls, String? videoUrl, Failure? failure
});
...
/// Create a copy of BookmarkFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? status = null,Object? title = null,Object? url = null,Object? description = null,Object? tags = null,Object? imageUrls = null,Object? videoUrl = freezed,Object? failure = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  BookmarkFormStatus status,  String title,  String url,  String description,  List<String> tags,  List<String> imageUrls,  String? videoUrl,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookmarkFormState() when $default != null:
return $default(_that.id,_that.status,_that.title,_that.url,_that.description,_that.tags,_that.imageUrls,_that.videoUrl,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  BookmarkFormStatus status,  String title,  String url,  String description,  List<String> tags,  List<String> imageUrls,  String? videoUrl,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _BookmarkFormState():
return $default(_that.id,_that.status,_that.title,_that.url,_that.description,_that.tags,_that.imageUrls,_that.videoUrl,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  BookmarkFormStatus status,  String title,  String url,  String description,  List<String> tags,  List<String> imageUrls,  String? videoUrl,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _BookmarkFormState() when $default != null:
return $default(_that.id,_that.status,_that.title,_that.url,_that.description,_that.tags,_that.imageUrls,_that.videoUrl,_that.failure);case _:
  return null;
...
class _BookmarkFormState implements BookmarkFormState {
  const _BookmarkFormState({this.id, this.status = BookmarkFormStatus.idle, this.title = '', this.url = '', this.description = '', final  List<String> tags = const [], final  List<String> imageUrls = const [], this.videoUrl, this.failure}): _tags = tags,_imageUrls = imageUrls;
...
@override
int get hashCode => Object.hash(runtimeType,id,status,title,url,description,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_imageUrls),videoUrl,failure);
...
/// Create a copy of BookmarkFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? status = null,Object? title = null,Object? url = null,Object? description = null,Object? tags = null,Object? imageUrls = null,Object? videoUrl = freezed,Object? failure = freezed,}) {
