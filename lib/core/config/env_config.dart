...
class EnvConfig {
  ...
  String get androidApiKey => const String.fromEnvironment('FIREBASE_ANDROID_API_KEY');

  String get androidAppId => const String.fromEnvironment('FIREBASE_ANDROID_APP_ID');

  String get androidMessagingSenderId =>
      const String.fromEnvironment('FIREBASE_ANDROID_MESSAGING_SENDER_ID');

  String get androidProjectId => const String.fromEnvironment('FIREBASE_ANDROID_PROJECT_ID');
  ...
  String get iosProjectId => const String.fromEnvironment('FIREBASE_IOS_PROJECT_ID');

  String get iosStorageBucket =>
      const String.fromEnvironment('FIREBASE_IOS_STORAGE_BUCKET');

  String get iosClientId => const String.fromEnvironment('FIREBASE_IOS_CLIENT_ID');

  String get iosBundleId => const String.fromEnvironment('FIREBASE_IOS_BUNDLE_ID');
